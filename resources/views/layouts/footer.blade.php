<footer class="text-gray-600 body-font">
  ...
  <div class="bg-gray-100">
    <div class="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
      ...
      <p class="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2022 Pablos — 
        <a href="https://tailblocks.cc/" rel="noopener noreferrer" class="text-gray-600 ml-1" target="_blank">https://tailblocks.cc/</a>
      </p>
